...
## (3)Usage
In the notebook,import the field seismic data in this line: 'f3 = np.load("/data/max/FaultNet-main/data/F3.npy").transpose((2, 1, 0)).  Then, run the notebook from start.
